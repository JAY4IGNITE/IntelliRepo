...
export function LandingPage() {
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="mx-auto max-w-7xl px-6 pb-24 pt-20">
        <section className="grid gap-12 lg:grid-cols-[1.2fr,0.8fr] lg:items-center">
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
              {stats.map((stat) => (
                <div key={stat.label} className="rounded-3xl border border-surface-200 bg-card p-5 text-center shadow-sm shadow-slate-900/10 dark:border-surface-800 dark:bg-surface-900">
          ...
          <div className="rounded-[2rem] border border-surface-200 bg-card/95 p-8 shadow-[0_32px_120px_-90px_rgba(56,189,248,0.15)] backdrop-blur-xl dark:border-surface-800 dark:bg-surface-900/95">
            <div className="rounded-3xl border border-surface-200 bg-surface-100 p-6 dark:border-surface-800 dark:bg-surface-900">
              <div className="flex items-center justify-between gap-4 pb-5">
                <div>
                  <p className="text-sm uppercase tracking-[0.24em] text-primary-300">Live analysis</p>
                  <h2 className="mt-3 text-xl font-semibold text-foreground dark:text-white">Repository health overview</h2>
                </div>
                <span className="rounded-full bg-primary-500/15 px-3 py-1 text-sm text-primary-200">AI</span>
              </div>

              <div className="space-y-4">
                <div className="rounded-3xl bg-surface-100/90 p-5 ring-1 ring-surface-200 dark:bg-surface-900/90 dark:ring-surface-700">
                  <div className="flex items-center justify-between text-sm text-muted-foreground">
                    <span>Open issues</span>
                    <span className="font-semibold text-foreground dark:text-white">24</span>
                  </div>
                  <div className="mt-3 h-2 overflow-hidden rounded-full bg-surface-200 dark:bg-surface-700">
                ...
                <div className="rounded-3xl bg-surface-100/90 p-5 ring-1 ring-surface-200 dark:bg-surface-900/90 dark:ring-surface-700">
                  <div className="flex items-center justify-between text-sm text-muted-foreground">
                    ...
                    <span className="font-semibold text-foreground dark:text-white">87%</span>
                  </div>
                  <div className="mt-3 h-2 overflow-hidden rounded-full bg-surface-200 dark:bg-surface-700">
                ...
                <div className="rounded-3xl bg-surface-100/90 p-5 ring-1 ring-surface-200 dark:bg-surface-900/90 dark:ring-surface-700">
                  ...
                  <p className="mt-2 text-lg font-semibold text-foreground dark:text-white">TypeScript</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="mt-20 grid gap-6 lg:grid-cols-4">
          {features.map(({ icon: Icon, title, description }) => (
            <div key={title} className="group rounded-3xl border border-surface-200 bg-card p-6 transition hover:-translate-y-1 hover:border-primary-500/40 hover:bg-surface-100 shadow-sm shadow-slate-900/10 dark:border-surface-800 dark:bg-surface-900/80 dark:hover:bg-surface-800">
              ...
              <h3 className="mt-5 text-lg font-semibold text-foreground dark:text-white">{title}</h3>
              <p className="mt-3 text-sm leading-7 text-muted-foreground">{description}</p>
            </div>
          ))}
        </section>

        <section className="mt-20 rounded-[2rem] border border-surface-200 bg-card/95 p-8 shadow-xl shadow-slate-900/10 dark:border-surface-800 dark:bg-surface-900/95">
          <div className="grid gap-8 lg:grid-cols-[1fr,0.9fr] lg:items-center">
            <div>
              ...
              <h2 className="mt-4 text-3xl font-semibold text-foreground dark:text-white">From GitHub sync to intelligent recommendations.</h2>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="rounded-3xl border border-surface-200 bg-surface-100/90 p-5 dark:border-surface-800 dark:bg-surface-900/90">
                <p className="text-lg font-semibold text-foreground dark:text-white">1. Connect GitHub</p>
                <p className="mt-3 text-sm text-muted-foreground">Link your account and authorize IntelliRepo to analyze your repositories securely.</p>
              </div>
              <div className="rounded-3xl border border-surface-200 bg-surface-100/90 p-5 dark:border-surface-800 dark:bg-surface-900/90">
                <p className="text-lg font-semibold text-foreground dark:text-white">2. Review insights</p>
                <p className="mt-3 text-sm text-muted-foreground">Access dashboard metrics, risk summaries, and code quality signals in one place.</p>
              </div>
            </div>
          </div>
        </section>

        <section className="mt-20 rounded-[2rem] border border-surface-200 bg-card p-10 text-center shadow-sm shadow-slate-900/10 dark:border-surface-800 dark:bg-surface-900">
          <p className="text-sm uppercase tracking-[0.24em] text-primary-300">Ready to launch</p>
          <h2 className="mt-4 text-3xl font-semibold text-foreground dark:text-white">Build better software with confidence</h2>
      ...
      <footer className="border-t border-surface-200 bg-card/95 py-8 text-center text-sm text-muted-foreground dark:border-surface-800 dark:bg-surface-900/95">
